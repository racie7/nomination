								...
								<form style="color:black" action="{{ route('team-awards') }}" method="post">
									...
									<div class="form-group">
										<select class="custom-select" name="user" id="inputGroupSelect02">
											{{--<option selected>--Choose one team--</option>--}}
									...
									<div class="radio-label-vertical-wrapper">
										<div class="form-group" style="color:black">
											<span class="required">*</span><strong>
                                                Excellence:</strong> In a Scale of 1 to 5, how would you rate the team with respect
									...
									<div class="radio-label-vertical-wrapper">
										<div class="form-group" style="color:black">
											<span class="required">*</span><strong>
                                                Innovation and Creativity:</strong>  In a Scale of 1 to 5 how you rate the team in developing innovative and
									...
									<div class="radio-label-vertical-wrapper">
										<div class="form-group" style="color:black">
											<span class="required">*</span><strong>Measurable Success:</strong>  In a Scale of 1 to 5, how would you rate the
									...
									<div class="radio-label-vertical-wrapper">
										<div class="form-group" style="color:black">
											<span class="required">*</span><strong>Professionalism:</strong>In a Scale of 1 to 5, how would rate the team
